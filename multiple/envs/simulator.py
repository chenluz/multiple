...
# f = feedback()
# import numpy as np
# for t in np.linspace(21,26,30):
#     skin1 = s.comfPierceSET(t, t-1, 35, 0.4)
#     skin2 = s.comfPierceSET(t, t-1, 35, 0.7)
#     skin3 = s.comfPierceSET(t, t-1, 35, 1.0)
#     feed = f.comfPMV(t,t-1, 35, 1.0)
#     print(t, skin1, skin2, skin3, feed[1])